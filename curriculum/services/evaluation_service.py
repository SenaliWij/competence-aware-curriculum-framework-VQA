...
class EvaluationService:
    ...
    def get_moving_average_accuracy(self, window: int = None) -> float:
        ...
        Parameters:
            window: r number of recent epochs to use.
    ...
    def is_loss_stable(self, threshold: float = 5e-3, window: int = None) -> bool:
        ...
        If the absolute difference between the earliest and latest loss in the selected window is < than the given threshold, the loss is considered stable.

        Parameters:
            threshold: Maximum allowed change in loss across the window.
